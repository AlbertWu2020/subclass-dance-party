describe('happyDancer', function() {
  ...
  it('should have a setPosition method', function() {
    expect(happyDancer.setPosition).to.be.a('function');
  });

  it('should have a lineUp method', function() {
    expect(happyDancer.lineUp).to.be.a('function');
  });

  it('should be instance of prototype', function() {
    expect(makeHappyDancer.prototype).to.equal(happyDancer.__proto__);
    expect(happyDancer).to.be.an.instanceOf(makeHappyDancer);
  });
